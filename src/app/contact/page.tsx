      ...
      <section className="bg-white">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form ref={formRef} onSubmit={sendEmail} className="space-y-8">
            <div>
              <label htmlFor="email" className="block mb-2 text-sm font-[avenirlight] text-gray-800">
                Your email
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="subject" className="block mb-2 text-sm font-[avenirlight] text-gray-800">
                Subject
              </label>
              <input
                type="text"
            ...
            <div className="sm:col-span-2">
              <label htmlFor="message" className="block mb-2 text-sm font-[avenirlight] text-gray-800">
                Your message
              </label>
              <textarea
                name="message"
