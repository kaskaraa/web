  ...
  return (
    <>
      ...
      <section className="py-14 lg:py-24 relative">
        ...
        <div class="py-4 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
            <div class="max-w-2xl mx-auto text-center">
              <h2 class="text-slate-900 text-4xl font-bold">Meet our team</h2>
              <p class="text-slate-600 text-sm mt-6 leading-relaxed">
                Veniam proident aute magna anim excepteur et ex consectetur
                velit ullamco veniam minim aute sit. Ullamco nisi enim ipsum
                irure laboris ad ut. Esse cupidatat deserunt magna aute.
              </p>
            </div>
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-md:justify-center mt-12 max-md:max-w-xs mx-auto">
              <div class="border rounded-md overflow-hidden bg-gray-100">
                <img
                  ...
                  class="w-full object-contain aspect-square object-top bg-gray-200"
                />
              ...
              <div class="border rounded-md overflow-hidden">
                <img
                  ...
                  class="w-full object-contain object-top bg-gray-200"
                />
              ...
              <div class="border rounded-md overflow-hidden">
                ...
                <div class="p-4">
                  ...
                  <p class="text-slate-600 text-xs mt-1">Web Designer</p>
