        ...
        <footer className="bg-white">
            <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-[Avenir] font-bold  text-gray-300 whitespace-nowrap">Xiphos Labs</span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">© 2025 <a href="" className="hover:underline">Xiphoslabs™</a>. All Rights Reserved.</span>
